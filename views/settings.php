...
<div id="container" class="snapshot-three wps-page-settings">
	...
	$apiKey = isset(PSOURCESnapshot::instance()->config_data['config']['secret-key']) ? PSOURCESnapshot::instance()->config_data['config']['secret-key'] : $model->get_config('secret-key', ''); ?>
