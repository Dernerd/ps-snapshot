...
<section class="wpmud-box wps-widget-backups">
	...
	<div class="wpmud-box-title<?php if ($has_snapshot_key === true) : echo ' has-button'; else : echo ' has-tag'; endif; ?>">
		...
		<?php if ( $is_client === true ) { ?>
			...
			<a href="<?php echo PSOURCESnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-settings') . '#wps-settings-backups'; ?>" class="button button-small button-outline button-gray"><?php _e('Configure' , SNAPSHOT_I18N_DOMAIN); ?></a>
			...
			<div class="col-xs-12">
				...
				<?php if ( $has_snapshot_key === true ) :
					...
					if ( $has_backups === true ) : ?>
						...
						<p><?php printf( __( 'Backup your entire WordPress installation and store it securely in the <a href="%s">Hub</a> for simple site migration and one-click restoration.', SNAPSHOT_I18N_DOMAIN ), 'https://premium.psource.org/hub/' ); ?></p>
						...
						<table class="has-footer" cellpadding="0" cellspacing="0">
							...
							<tfoot>
								<tr>
									<td colspan="2">
										<a href="<?php echo PSOURCESnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-managed-backups' ); ?>" class="button button-outline button-gray">
					...
					<?php else: ?>
						...
						<p><a href="<?php echo PSOURCESnapshot::instance()->snapshot_get_pagehook_url('snapshots-newui-managed-backups'); ?>" class="button button-blue"><?php _e('Backup my site' , SNAPSHOT_I18N_DOMAIN); ?></a></p>
