	...
	<div class="wpmud-box-content">
		...
		<div class="wpmud-box-content-wrap">
			...
			<p class="align-buttons">
				...
				<a href="<?php echo PSOURCESnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-managed-backups' ); ?>" class="button button-blue"><?php _e( 'Try managed backups', SNAPSHOT_I18N_DOMAIN ); ?></a>
